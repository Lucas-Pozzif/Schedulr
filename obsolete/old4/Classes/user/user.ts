import { GoogleAuthProvider, UserCredential, signInAnonymously, signInWithPopup, signInWithRedirect, signOut } from "firebase/auth";
...
export class User {
  ...
  public async loginAnonymous() {
    ...
    this._id = userCredential.user.uid
  }
